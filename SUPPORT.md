...
Yes, to use AI-powered features (interview agent, architect analysis), you need an API key from one of the supported providers (OpenAI, Anthropic, Google, DeepSeek, OpenRouter).
